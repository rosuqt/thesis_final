...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $sql = "INSERT INTO registration (fullName, email, pw) VALUES ('$fullName', '$email', '$pw')";

        if ($conn->query($sql) === TRUE) {
            echo '<div id="successMessage">User added successfully</div>';
        } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <form action="TEST.php" method="POST">
        ...
        <br>
        <a href="crud_admin.php" class="special-link">Click here to add admin</a>
